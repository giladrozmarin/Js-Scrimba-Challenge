...
{
 const characters = document.querySelector("#string").value.length;
   let charactersRemaining = 140 - characters;
   let counterFooter = document.querySelector("#counterFooter");
   charactersRemaining < 0 ?  button.classList.add("buttonDisabled")
   :  counterFooter.innerHTML = `${charactersRemaining}/140`;
})